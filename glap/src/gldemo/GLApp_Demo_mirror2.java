...
public class GLApp_Demo_mirror2 extends GLApp {
    // Handle for texture
    ...
    static float	LightPos[] = {-4.0f, 4.0f, 16.0f, 1.0f};				// 灯光的位置
    ...
    public static void main(String args[]) {
        GLApp_Demo_mirror2 demo = new GLApp_Demo_mirror2();
    ...
    public void DrawGLScene(){
       ...
       // setLightPosition( GL11.GL_LIGHT0, LightPos);		// Set Up Light0 Position
        ...
        DrawFloor();	      airplaneShadow.drawShadow();									// Draw The Floor To The Screen
...
//        drawObjects();
    ...
    public void setup()
    {airplaneShadow = new GLShadowOnPlane(LightPos, new float[] {0f,1f,0f,3f}, null, this, method(this,"drawObjects"));
        eqr=
