         ...
         */
        public class GLApp_DemoMask extends GLApp {
            // Handle for texture
            int sphereTextureHandle = 0;
            int groundTextureHandle = 0;
            int maskHandle=0;
            int h0=0,h1,h2,h3,h4;
            ...
            public static void main(String args[]) {
                GLApp_DemoMask demo = new GLApp_DemoMask();
             ...
             */
            boolean masking=true,scene=true;
            public void draw() {
                ...
                GL11.glBindTexture(GL11.GL_TEXTURE_2D, h0);
                renderCube();
                ...
                {
                    GL11.glTranslatef(0.0f,0.0f,0.0f);					// 移入屏幕一个单位
                       GL11.glScalef(1.2f,1.2f,1.2f);
                    GL11.glRotatef(0*360,0.0f,0.0f,1.0f);

                    if (masking)							// “掩模”是否打开

                    {
                        GL11.glBindTexture(GL11.GL_TEXTURE_2D, h3);
                        renderCube();
                    } //GL11.glTranslatef(0.0f,1.0f,0.0f);
                    GL11.glBlendFunc( GL11.GL_ONE, GL11.GL_ONE);
                    GL11.glBindTexture(GL11.GL_TEXTURE_2D, h4);
                    renderCube();
                }else{
                    if(masking){
                        GL11.glBindTexture(GL11.GL_TEXTURE_2D, h1);
                        renderCube();
                    }
                    GL11.glBlendFunc( GL11.GL_ONE, GL11.GL_ONE);
                    GL11.glBindTexture(GL11.GL_TEXTURE_2D, h2);
                    renderCube();
                }
