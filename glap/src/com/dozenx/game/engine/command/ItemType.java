...
public enum ItemType {
    ...
    bread,billboard,wood_door,iron_door,bed,pant_slot,fur_shoe,
    ...
    grit_block,soil_block,stone_block,wood_block,glass_block,sand_block,mantle_block,water_block;
    public int getType(){
        return this.ordinal();
    }
