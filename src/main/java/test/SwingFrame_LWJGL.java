...
public class SwingFrame_LWJGL {
    ...
    public static void main(String[] args) { System.setProperty("org.lwjgl.librarypath","/home/colamachine/workspace/MyBlock/bin/natives/linux");
    ...
    public SwingFrame_LWJGL() {
        ...
        canvasPanel.setLayout(new BorderLayout(2, 0));
        ...
        canvasPanel.add(button,BorderLayout.LINE_END);
