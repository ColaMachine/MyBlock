...
public class GL_Triangle
{
        ...
        public GL_Triangle makeClone()
        {
            ...
            clone.norm1 = norm1.copyClone();
            clone.norm2 = norm2.copyClone();
            clone.norm3 = norm3.copyClone();
            clone.uvw1 = uvw1.copyClone();
            clone.uvw2 = uvw2.copyClone();
            clone.uvw3 = uvw3.copyClone();
