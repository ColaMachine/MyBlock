 ...
 */
public class DirBlockDefinition extends BlockDefinition {
    private static final Logger logger = LoggerFactory.getLogger(DirBlockDefinition.class);
    public HashMap<Integer, BaseBlock> idShapeMap = new HashMap<>();

    public DirBlockDefinition() {
      //  this.setShape();
    }
