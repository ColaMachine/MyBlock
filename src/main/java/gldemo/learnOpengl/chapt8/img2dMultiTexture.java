package gldemo.learnOpengl.chapt8;
 ...
 */
public class img2dMultiTexture {
...
//            vector.x=vector.x/VerticesArray[2+i*8];
//            vector.y=vector.y/VerticesArray[2+i*8];
//            vector.z=vector.z/VerticesArray[2+i*8];
...
//            if( VerticesArray[2+i*8]>0.5){
//               // VerticesArray[2+i*8]=0.5f;
//            }
//        }
    ...
    public static void main(String[] args) {
        ...
        img2dMultiTexture main = null;
        try {
            main = new img2dMultiTexture();
            main.create();
            main.run();
        } catch (Exception ex) {
            ex.printStackTrace();
