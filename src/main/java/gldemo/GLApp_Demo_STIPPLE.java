 ...
 */
public class GLApp_Demo_STIPPLE extends GLApp {
    // Handle for texture
    ...
    public static void main(String args[]) {
    	GLApp_Demo_STIPPLE demo = new GLApp_Demo_STIPPLE();
    ...
    public void setup()
    {
        ...
        sphereTextureHandle = makeTexture("E:\\zhangzhiwei\\minecraft\\.minecraft\\versions\\1.2.5ԭ��\\minecraft\\gui\\background.png");
